...
const IMOVEIS_COLS = new Set([
  ...
  // Sprint 11: campos novos baseados na análise Ninja
  'area_construida_m2','praca','investimento_total','roi_estimado',
    ...
    try {
      ...
      if (atual) {
        const CAMPOS_PROTEGIDOS = ['valor_minimo','valor_avaliacao','titulo','score_total',
          ...
          // Sprint 23: proteger reforma calculada
          'custo_reforma_basica','custo_reforma_media','custo_reforma_completa','reforma_detalhada',
          // Sprint 31: proteger dados de usuário e campos críticos adicionais
          'notas_privadas','sintese_executiva',
