...
const DADOS_BANCO = [
  ...
  { nome:'jurimetria_varas', registros:3, atualizado:'29/03/2026', fonte:'CNJ DataJud + ABRAIM 2024', descricao:'Tempo real de ciclo por vara — TRT-3 (240 dias), TJMG Cível (180 dias). Usado para calcular prazo de liberação estimado.', campos:['vara_nome','tempo_total_ciclo_dias','taxa_embargo_pct','taxa_sucesso_posse_pct'] },
